import{c as o,r as n,m as i}from"./render-template.ec07a378.js";import{u as a}from"./hoisted.26653573.js";import"./astro-assets-services.5d54009f.js";const t=`<h2 id="tldr">tldr</h2>
<ol>
...
<li>Create an account @ <a href="https://webmention.io/">Webmention.io</a>.</li>
...
<li>Go to <a href="https://brid.gy/">brid.gy</a> and sign-in to each social account[s] you wish to link.</li>
<li>Publish and build your website, remember to add the api key, and it should now be ready to receive webmentions!</li>
<li>That’s it, I just wanted to finish on a cool number.</li>
</ol>
...
<ul>
<li>
<p>Next is to add your api key, also from <a href="https://webmention.io/">Webmention.io</a>, to a <code>.env</code> file. Rename the <code>.example.env</code>, or create your own, with <code>WEBMENTION_API_KEY=</code> and then your personal key. Please try not to publish this to a repository.</p>
</li>
<li>
<p>You’re now going to have to sign-up to <a href="https://brid.gy/">brid.gy</a>. As the name suggests, it links your website to your social media accounts (you need to add your website to these social accounts if you don’t already), so sign-up/connect each account you intend brid.gy to search. Just a thing to note again, brid.gy currently has an issue with .app TLD domains.</p>
</li>
</ul>
...
<p>With everything setup and live, you can check to see if everything is working by sending a test webmention via <a href="https://webmention.rocks/receive/1">webmentions.rocks</a>. Log in with your domain, enter the auth code, and then the url of the page you want to test. For example, to test this page I would add <code>https://astro-cactus.chriswilliams.dev/posts/webmentions/</code>. To view it on your website, rebuild or [re]start dev mode locally, and you should see the result at the bottom of your page.</p>
<p>You can also view any test mentions in the browser via the <a href="https://github.com/aaronpk/webmention.io#api">api</a>.</p>
...
<p>Many thanks to <a href="https://github.com/chrismwilliams/astro-theme-cactus/issues/107#issue-1863931105">Kieran McGuire</a> for sharing this with me, and the helpful posts. I’d never heard of webmentions before, and now with this update hopefully others will be able to make use of them. Additionally, articles and examples from <a href="https://kld.dev/adding-webmentions/">kld</a> and <a href="https://ryanmulligan.dev/blog/">ryanmulligan.dev</a> really helped in getting this set up and integrated, both a great resource if you’re looking for more information!</p>`,s={title:"Adding Webmentions to Astro Cactus",description:"This post describes the process of adding webmentions to your own site",publishDate:"11 Oct 2023",tags:["astro"],draft:!0,minutesRead:"4 min read"},r="/home/ignacio/DevHome/blog-dev-astro/src/content/post/webmentions/index.md",d=void 0;function g(){return`
## tldr
