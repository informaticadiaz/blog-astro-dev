import{c as a,r as e,m as l}from"./render-template.ec07a378.js";import{u as o}from"./hoisted.26653573.js";import"./astro-assets-services.5d54009f.js";const s=`<h1 id="css-layout-horizontal-and-vertical-align">CSS Layout Horizontal and Vertical Align</h1>
...
<pre class="astro-code dracula" style="background-color: #282A36; overflow-x: auto; white-space: pre-wrap; word-wrap: break-word;" tabindex="0"><code><span class="line"><span style="color: #F8F8F2"> </span><span style="color: #FF79C6">div</span><span style="color: #F8F8F2"> {</span></span>
...
<pre class="astro-code dracula" style="background-color: #282A36; overflow-x: auto; white-space: pre-wrap; word-wrap: break-word;" tabindex="0"><code><span class="line"><span style="color: #F8F8F2"> </span><span style="color: #FF79C6">div</span><span style="color: #50FA7B; font-style: italic">.container</span><span style="color: #F8F8F2"> {</span></span>
<span class="line"><span style="color: #F8F8F2"> </span><span style="color: #8BE9FD">padding-top</span><span style="color: #FF79C6">:</span><span style="color: #F8F8F2"> </span><span style="color: #BD93F9">40</span><span style="color: #FF79C6">px</span><span style="color: #F8F8F2">;</span></span>
<span class="line"><span style="color: #F8F8F2"> </span><span style="color: #8BE9FD">padding-bottom</span><span style="color: #FF79C6">:</span><span style="color: #F8F8F2"> </span><span style="color: #BD93F9">40</span><span style="color: #FF79C6">px</span><span style="color: #F8F8F2">;</span></span>
...
<span class="line"><span style="color: #F8F8F2"> }</span></span>
<span class="line"><span style="color: #F8F8F2"> </span><span style="color: #FF79C6">div</span><span style="color: #50FA7B; font-style: italic">.content</span><span style="color: #F8F8F2"> {</span></span>
...
<pre class="astro-code dracula" style="background-color: #282A36; overflow-x: auto; white-space: pre-wrap; word-wrap: break-word;" tabindex="0"><code><span class="line"><span style="color: #F8F8F2">.center {</span></span>
<span class="line"><span style="color: #F8F8F2">    position: relative;</span></span>
<span class="line"><span style="color: #F8F8F2">    height: 500px;</span></span>
<span class="line"><span style="color: #F8F8F2">    border: 3px solid #173459;</span></span>
<span class="line"><span style="color: #F8F8F2">}</span></span>
<span class="line"><span style="color: #F8F8F2">.center > p {</span></span>
<span class="line"><span style="color: #F8F8F2">    position: absolute;</span></span>
<span class="line"><span style="color: #F8F8F2">    top: 50%;</span></span>
<span class="line"><span style="color: #F8F8F2">    left: 50%;</span></span>
<span class="line"><span style="color: #F8F8F2">    transform: translate(-50%, -50%);</span></span>
<span class="line"><span style="color: #F8F8F2">}</span></span></code></pre>
<p>Note you’ll learn about the transform css property in our 2d transforms leasson.</p>`,t={title:"CSS Align",description:"CSS Layout - Horizontal and Vertical Align. how to align elements horizontally, vertically. Alinear vertical horizontal.",publishDate:"10 Sept 2023",tags:["CSS"],draft:!0,minutesRead:"3 min read"},p="/home/ignacio/DevHome/blog-dev-astro/src/content/post/css-align2.md",r=void 0;function m(){return`
