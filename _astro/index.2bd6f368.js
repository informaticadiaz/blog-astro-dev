...
`,n(e.pre,{class:"astro-code dracula",style:{backgroundColor:"#282A36",overflowX:"auto",whiteSpace:"pre-wrap",wordWrap:"break-word"},tabindex:"0",children:n(e.code,{children:n(e.span,{class:"line",children:[n(e.span,{style:{color:"#FF79C6"},children:"let"}),n(e.span,{style:{color:"#F8F8F2"},children:" string "}),n(e.span,{style:{color:"#FF79C6"},children:"="}),n(e.span,{style:{color:"#F8F8F2"},children:" "}),n(e.span,{style:{color:"#E9F284"},children:'"'}),n(e.span,{style:{color:"#F1FA8C"},children:"JavaScript syntax highlighting"}),n(e.span,{style:{color:"#E9F284"},children:'"'}),n(e.span,{style:{color:"#F8F8F2"},children:";"})]})})}),`
...
`]})]})}function x(t={}){const{wrapper:e}=t.components||{};return e?n(e,{...t,children:n(c,{...t})}):c(t)}const H="src/content/post/hello-world/index.mdx",C="/home/ignacio/DevHome/blog-dev-astro/src/content/post/hello-world/index.mdx",i=(t={})=>x({...t,components:{Fragment:d,...t.components,"astro-image":t.components?.img??g}});i[Symbol.for("mdx-component")]=!0;i[Symbol.for("astro.needsHeadRendering")]=!w.layout;i.moduleId="/home/ignacio/DevHome/blog-dev-astro/src/content/post/hello-world/index.mdx";export{i as Content,j as __usesAstroImage,i as default,C as file,w as frontmatter,_ as getHeadings,H as url};
