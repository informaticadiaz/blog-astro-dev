import{s as l,g as a}from"./_astro_assets.e6dd1bec.js";import{c as r,r as d,m as p}from"./render-template.ec07a378.js";import{u as c}from"./hoisted.26653573.js";import"./astro-assets-services.5d54009f.js";const h={src:"/_astro/logo.1c6fa3ee.png",width:512,height:512,format:"png"},u={src:"/_astro/about-astro.850f94c9.png",width:249,height:450,format:"png"},g=async function(){return{"./logo.png":await a({src:h}),"@/assets/about-astro.png":await a({src:u})}};async function f(t){return g().then(e=>t.replaceAll(/__ASTRO_IMAGE_="([^"]+)"/gm,(i,n)=>l({src:e[n].src,...e[n].attributes})))}const o=await f(`<h2 id="this-is-a-h2-heading">This is a H2 Heading</h2>
...
<p>Indented code</p>
<pre class="astro-code dracula" style="background-color: #282A36; overflow-x: auto; white-space: pre-wrap; word-wrap: break-word;" tabindex="0"><code><span class="line"><span style="color: #F8F8F2">// Some comments</span></span>
...
<pre class="astro-code dracula" style="background-color: #282A36; overflow-x: auto; white-space: pre-wrap; word-wrap: break-word;" tabindex="0"><code><span class="line"><span style="color: #F8F8F2">Sample text here...</span></span></code></pre>
...
</section>`),m={title:"A post of Markdown elements",description:"This post is for testing and listing a number of different markdown elements",publishDate:"22 Feb 2023",tags:["test","markdown"],draft:!0,minutesRead:"2 min read"},b="/home/ignacio/DevHome/blog-dev-astro/src/content/post/markdown-elements/index.md",F=void 0;function H(){return`
